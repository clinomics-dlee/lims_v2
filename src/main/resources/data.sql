...
INSERT INTO member (id, dept, email, is_failed_mail_sent, in_use, name, password) SELECT 'admin', 'IT Infra', 'info@clinomics.com', 1, 1, 'Administrator', '$10$8y7E2JJg7d68OQSFKw5rmePUCEd5NtyCKhoX5Ue.0n46veUaHw6Oq' FROM DUAL WHERE NOT EXISTS (SELECT * FROM member WHERE id = 'admin');
